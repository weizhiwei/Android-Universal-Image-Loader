...
public abstract class PanoramioViewNode extends ViewNode {

	protected static String URL_PREFIX = "http://www.panoramio.com";
	
	public PanoramioViewNode(String sourceUrl) {
		super(sourceUrl);
        supportPaging = false;
	}
