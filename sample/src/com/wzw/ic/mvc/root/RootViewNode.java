...
public class RootViewNode extends ViewNode {
	...
	public static final ViewItem ROOT_VIEW_ITEM = new ViewItem("iC", "ic", null, ViewItem.VIEW_TYPE_LIST, new RootViewNode());
	...
	public RootViewNode() {
		super("root", Arrays.asList(
			...
			new ViewItem("Flickr", "flickr", FlickrViewNode.FLICKR_ICON, ViewItem.VIEW_TYPE_LIST, new FlickrViewNodeRoot()),
//			new ViewItem("Fotopedia", "fotopedia", FotoViewNode.FOTO_ICON, ViewItem.VIEW_TYPE_LIST, new FotoViewNodeRoot()),
			new ViewItem("National Geographic", "nationalgeographic", NGViewNode.NG_ICON, ViewItem.VIEW_TYPE_LIST, new NGViewNodeRoot())
		));
	}
}
