...
public abstract class LonelyPlanetViewNode extends ViewNode {

	protected static String URL_PREFIX = "http://www.lonelyplanet.com";

	public LonelyPlanetViewNode(String sourceUrl) {
		super(sourceUrl);
        supportPaging = false;
	}
